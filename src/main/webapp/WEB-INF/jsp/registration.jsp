				...
				<form:form method="POST" modelAttribute="userForm"
					...
					<spring:bind path="username">
						<div class="form-group ${status.error ? 'has-error' : ''}"
							id="usernamereg">
							<br> <label for="">Felhasználónév</label> <br>
							<form:input type="text" path="username"
								class="form-control pt-3 pb-3 mx-2" placeholder="Felhasználónév"
								autofocus="true"></form:input>
							<br>
							<form:errors class="justify-content-center text-light bg-danger"
					...
					<spring:bind path="email">
						<div class="form-group ${status.error ? 'has-error' : ''}"
							id="emailreg">
							<br> <label for="">E-mail cím</label> <br>
					...
					<spring:bind path="password">
						<div class="form-group ${status.error ? 'has-error' : ''}"
							id="passwordreg">
							<br> <label for="">Jelszó</label> <br>
							<form:input type="password" path="password"
								class="form-control pt-3 pb-3 mx-2" placeholder="Jelszó"></form:input>
							<br>
							<form:errors class="justify-content-center text-light bg-danger"
					...
					<spring:bind path="passwordConfirm">
						<div class="form-group ${status.error ? 'has-error' : ''}"
							id="passwordregok">
							<br> <label for="">Jelszó megerősítése</label> <br>
							<form:input type="password" path="passwordConfirm"
								class="form-control pt-3 pb-3 mx-2"
								placeholder="Jelszó megerősítése"></form:input>
							<br>
							<form:errors class="justify-content-center text-light bg-danger"
								path="passwordConfirm"></form:errors>
